...
def load_word_matrix(vocabulary, size=200):
    ...
    model = word2vec.Word2Vec.load('./supplemental/word2vec/word2vec_200dim.model')
...
def load_data():
    ...
    x, x_c, img_x, y = pad_sequence(sentences, img_to_feature, vocb, vocb_char, labelVoc, word_maxlen=30,
                                    sent_maxlen=35)
